...
<?php
//---------------  Posts Count and comments count --------------------------------//
$comments_args = array(
	'status' => 'approve'
);
...
{
	$post_id = $comment->comment_podt_ID;

	if(! in_category('javascript' , $post_id)) // check if post not in Linux category
	{
